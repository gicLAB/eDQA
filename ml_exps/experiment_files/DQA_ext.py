...
if args.model == 'resnet32' or args.model == 'mobilev2':
...
if args.method == 'dqa':
    ...
    import models_with_algorithm.mobilenetv2_pad_saw as mobilenetv2
    ...
    import models_with_algorithm.mobilenetv2_pad_saw_pot as mobilenetv2
    ...
    import models_with_algorithm.mobilenetv2_pad_saw_plain as mobilenetv2
...
with open('experiment_res/DQA_res_' + str(args.model) + '_' + str(args.method) + '_seed_' + str(args.seed) + '_bit_' + str(args.bit) + '.pkl', 'wb') as file:
