...
#from models_with_algorithm.mobilenetv2_pad_saw import MobileNetV2
#import models_with_algorithm.resnet_pad_saw as resnet
#import models_with_algorithm.resnet_pad_saw_log as resnet
from models_with_algorithm.mobilenetv2_pad_saw_pot import MobileNetV2
import models_with_algorithm.resnet_pad_saw_pot as resnet
#import models_with_algorithm.res_18_baseline as res_18
import models_with_algorithm.res_18_pad_saw as res_18
import models_with_algorithm.vision_transformer_pad_saw as vit
#import models_with_algorithm.res_18_pad_saw_plain as res_18
#import models_with_algorithm.res_18_hardware as res_18
...
if args.model == 'resnet32':
    ...
    model = MobileNetV2(bit=args.bit, seed=args.seed)
    model = nn.DataParallel(model, device_ids=args.gpu).cuda()
...
'''
with open('experiment_res/DQA_res_' + str(args.model) + '_seed_' + str(args.seed) + '_bit_' + str(args.bit) + '.pkl', 'wb') as file:
