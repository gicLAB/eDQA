...
def average_acc_by_prefix(folder_path):
    ...
    pattern = re.compile(r"(.+)_easyquant_seed_\d+\_bit_5_tmlr_base.pkl")
...
if __name__ == "__main__":
    folder = '/home/wenhao/DQA_Exp_TMLR/experiment_res/'#"/home/wenhao/DQA_Exp_TMLR/experiment_files/ResNet32_Noisy_local/experiment_res"
